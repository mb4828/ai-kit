---
name: create-meeting
description: Create or prepare a structured Obsidian meeting note and maintain previous/next meeting navigation. Use only when Matt explicitly asks to create, log, prepare, or set up a meeting note.
---

1. Read `Cowork/Skills/create-meeting-skill.md` and the vault-root `AGENTS.md` before editing.
